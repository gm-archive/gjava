...
//				int status = javac.compile(args);
				...
				String res = "Projects" + File.separator + GCSharp.projectname + File.separator + "CSharp";
		...
		if (c.equals("testapp"))
			...
			try
				...
				p = Runtime.getRuntime().exec(
						"" + "\"" + "Projects" + File.separator + GCSharp.projectname + File.separator + "CSharp" + File.separator  + GCSharp.projectname + ".exe\"");
p.waitFor();
				BufferedReader b = new BufferedReader(new InputStreamReader(p.getErrorStream()));
				String line = null;
