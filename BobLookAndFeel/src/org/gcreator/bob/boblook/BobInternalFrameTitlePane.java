/*
 * @(#)BobInternalFrameTitlePane.java	1.35 05/11/17
 *
...
/**
 * Class that manages a Bob title bar
 * @version 1.35 11/17/05
 *
 * @since 1.3
 */
public class BobInternalFrameTitlePane 
    extends BasicInternalFrameTitlePane implements LayoutManager, ActionListener, PropertyChangeListener 
{
    ...
    public BobInternalFrameTitlePane(JInternalFrame frame) {
        super(frame);
    }
    ...
    private class Title extends FrameButton {
        ...
        public void paintComponent(Graphics g) {
            ...
            if (frameTitle != null) {
                BobGraphicsUtils.drawStringInRect(frame, g, frameTitle,
