/*
 * @(#)BobScrollPaneUI.java	1.20 05/11/17
 *
...
/**
 * A CDE/Bob L&F implementation of ScrollPaneUI.  
 * <p>
 ...
 * @author Hans Muller
 */
public class BobScrollPaneUI extends BasicScrollPaneUI
{
	    ...
	    public void propertyChange(PropertyChangeEvent e) {
		  ...
		  if (propertyName.equals("componentOrientation")) {
			...
			if (vsb != null && vsbBorder != null &&
			    ...
			    if (BobGraphicsUtils.isLeftToRight(pane)) {
	...
	if (vsb != null) {
	    if (BobGraphicsUtils.isLeftToRight(scrollpane)) {
	        vsbBorder = new CompoundBorder(vsbMarginBorderR, 
					       vsb.getBorder());
	    }
	    else {
