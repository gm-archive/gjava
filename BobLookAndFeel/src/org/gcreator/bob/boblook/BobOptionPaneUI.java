/*
 * @(#)BobOptionPaneUI.java	1.18 05/11/17
 *
...
/**
 * Provides the CDE/Bob look and feel for a JOptionPane.
 * <p>
 ...
 * @author Scott Violet
 */
public class BobOptionPaneUI extends BasicOptionPaneUI
{
    /**
      * Creates a new BobOptionPaneUI instance.
      */
    public static ComponentUI createUI(JComponent x) {
	return new BobOptionPaneUI();
    }
    ...
    /**
     * Returns null, CDE/Bob does not impose a minimum size.
     */
