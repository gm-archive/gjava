/*
 * @(#)BobDesktopIconUI.java	1.29 05/11/30
 *
...
/**
 * Bob rendition of the component.
 *
 * @version 1.29 11/30/05
 * @author Thomas Ball
 * @author Rich Schiavi
 */
public class BobDesktopIconUI extends BasicDesktopIconUI
{
    ...
    private BobInternalFrameTitlePane sysMenuTitlePane;
    ...
    public static ComponentUI createUI(JComponent c)    {
        return new BobDesktopIconUI();
    }

    public BobDesktopIconUI() {
    }
	...
	iconButton = createIconButton(defaultIcon);
        ...
        sysMenuTitlePane =  new BobInternalFrameTitlePane(frame);
        systemMenu = sysMenuTitlePane.getSystemMenu();

        BobBorders.FrameBorder border = new BobBorders.FrameBorder(desktopIcon);
	...
	JInternalFrame frame;
        ...
        public void paint(Graphics g) {
            ...
            // draw text -- clipping to truncate text like CDE/Bob
