/*
 * @(#)BobSplitPaneDivider.java	1.18 05/11/17
 *
 ...
 * @author Jeff Dinkins
 */
public class BobSplitPaneDivider extends BasicSplitPaneDivider
{
    /**
     ...
     */
    public BobSplitPaneDivider(BasicSplitPaneUI ui) {
        super(ui);
    ...
    private class MotifMouseHandler extends MouseHandler {
	    ...
	    if (e.getSource() == BobSplitPaneDivider.this &&
