...
public class BobBorders { 
    ...
    public static class InternalFrameBorder extends FrameBorder {
        ...
        // The size of the bounding box for Bob frame corners.
    ...
    public static class BobPopupMenuBorder extends AbstractBorder implements UIResource {
	protected Font   font;
	...
	/**
	 * Creates a BobPopupMenuBorder instance 
	 * 
	 */
	public BobPopupMenuBorder(
				    Font titleFont,
				    Color bgColor,
				    Color fgColor,
				    Color shadow,
	...
	public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
	    ...
	    BobGraphicsUtils.drawGroove(g, x, textLoc.y + TEXT_SPACING, 
					  width, GROOVE_HEIGHT,
