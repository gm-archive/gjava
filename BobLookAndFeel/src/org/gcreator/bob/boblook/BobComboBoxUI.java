/*
 * @(#)BobComboBoxUI.java	1.41 06/03/28
 *
 ...
 * @author Arnaud Weber
 */
public class BobComboBoxUI extends BasicComboBoxUI implements Serializable {
    Icon arrowIcon;
    static final int HORIZ_MARGIN = 3;

    public static ComponentUI createUI(JComponent c) {
        return new BobComboBoxUI();
    }  

    public void installUI(JComponent c) {
        super.installUI(c);
        arrowIcon = new BobComboBoxArrowIcon(UIManager.getColor("controlHighlight"),
    ...
    protected ComboPopup createPopup() {
        return new BobComboPopup( comboBox );
    }

    /**
     * Overriden to empty the MouseMotionListener.
     */
    protected class BobComboPopup extends BasicComboPopup {

        public BobComboPopup( JComboBox comboBox ) {
            super( comboBox );
        }

        /**
         * Bob combo popup should not track the mouse in the list.
         */
	...
	if (comboBox.isEnabled()) {
        ...
        if ( !comboBox.isEditable() ) {
            ...
            // Draw the separation
	    if(BobGraphicsUtils.isLeftToRight(comboBox)) {
	        r.x -= (HORIZ_MARGIN + 2);
	    }
	    else {
    ...
    static class BobComboBoxArrowIcon implements Icon, Serializable {
        private Color lightShadow;
        private Color darkShadow;
        private Color fill;

        public BobComboBoxArrowIcon(Color lightShadow, Color darkShadow, Color fill) {
    ...
    protected PropertyChangeListener createPropertyChangeListener() {
        return new BobPropertyChangeListener();
    }

    /**
     * This class should be made &quot;protected&quot; in future releases.
     */
    private class BobPropertyChangeListener
