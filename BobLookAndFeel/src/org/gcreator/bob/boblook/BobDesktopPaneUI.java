/*
 * @(#)BobDesktopPaneUI.java	1.26 05/11/17
 *
 ...
 * @author David Kloba
 */
public class BobDesktopPaneUI extends javax.swing.plaf.basic.BasicDesktopPaneUI
{

/// DesktopPaneUI methods
    public static ComponentUI createUI(JComponent d)    {
        return new BobDesktopPaneUI();
    }

    public BobDesktopPaneUI() {
    }

    protected void installDesktopManager() {
	desktopManager = desktop.getDesktopManager();
	if(desktopManager == null) {
	    desktopManager = new BobDesktopManager();
	    desktop.setDesktopManager(desktopManager);
            ((BobDesktopManager)desktopManager).adjustIcons(desktop);
	}
    }
...
////////////////////////////////////////////////////////////////////////////////////
///  BobDesktopManager class
////////////////////////////////////////////////////////////////////////////////////
    private class BobDesktopManager extends DefaultDesktopManager implements Serializable, UIResource {
        JComponent dragPane;
