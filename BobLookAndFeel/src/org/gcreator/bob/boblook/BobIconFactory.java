/*
 * @(#)BobIconFactory.java	1.31 05/11/17
 *
...
/**
 * Icon factory for the CDE/Bob Look and Feel
 * <p>
 ...
 * @author Georges Saab
 */
public class BobIconFactory implements Serializable
{
	...
	public void paintIcon(Component c, Graphics g, int x, int y) {
	    ...
	    // There are 4 "looks" to the Bob CheckBox:
		...
		// BobBorderFactory.drawBezel(g,x,y,csize,csize,false,false);
    ...
    private static class MenuArrowIcon implements Icon, UIResource, Serializable 
    {
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            if (model.isSelected()){
                if( BobGraphicsUtils.isLeftToRight(c) ){
                    g.setColor(shadow);
