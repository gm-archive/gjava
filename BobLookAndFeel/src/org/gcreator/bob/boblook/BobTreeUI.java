...
/**
 * Bob rendition of the tree component.
 * <p>
 ...
 * @author Jeff Dinkins
 */
public class BobTreeUI extends BasicTreeUI
{
    static final int HALF_SIZE = 7;
    static final int SIZE = 14;

    /**
     * creates a UI object to represent a Bob Tree widget
     */
    public BobTreeUI() {
	super();
    }
     ...
     * long term persistence.
     */
    public static class BobExpandedIcon implements Icon, Serializable {
	static Color bg;
	static Color fg;
	static Color highlight;
	static Color shadow;

	public BobExpandedIcon() {
     ...
     * long term persistence.
     */
    public static class BobCollapsedIcon extends BobExpandedIcon {
        public static Icon createCollapsedIcon() {
	    return new BobCollapsedIcon();
        }
	...
	return new BobTreeCellRenderer();
    }
