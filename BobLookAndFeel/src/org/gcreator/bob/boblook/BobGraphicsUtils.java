/*
 * @(#)BobGraphicsUtils.java	1.48 05/11/30
 *
...
public class BobGraphicsUtils implements SwingConstants 
{       
...
//            throw new InconsistencyException("No metrics for Font " + font());
  ...
  public static void paintMenuItem(Graphics g, JComponent c,
	...
	if(acceleratorText != null && !acceleratorText.equals("")) {
		...
		Integer maxValueInt = (Integer) p.getClientProperty(BobGraphicsUtils.MAX_ACC_WIDTH);
