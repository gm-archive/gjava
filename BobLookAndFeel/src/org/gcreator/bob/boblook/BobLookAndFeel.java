...
/**
 * Implements the Bob Look and Feel.
 * UI classes not implemented specifically for Bob will
...
public class BobLookAndFeel extends BasicLookAndFeel
{
     ...
     * created on a native Bob platform we use the SystemColor
     * values, otherwise we create color objects whose values match
     * the default Bob colors.
     */
    ...
    protected void initClassDefaults(UIDefaults table)
    {
        ...
        String bobPackageName = "org.gcreator.bob.boblook.";

        Object[] uiDefaults = {
                   "ButtonUI", bobPackageName + "BobButtonUI",
                 "CheckBoxUI", bobPackageName + "BobCheckBoxUI",
            "DirectoryPaneUI", bobPackageName + "BobDirectoryPaneUI",
              "FileChooserUI", bobPackageName + "BobFileChooserUI",
                    "LabelUI", bobPackageName + "BobLabelUI",
                  "MenuBarUI", bobPackageName + "BobMenuBarUI",
                     "MenuUI", bobPackageName + "BobMenuUI",
                 "MenuItemUI", bobPackageName + "BobMenuItemUI",
         "CheckBoxMenuItemUI", bobPackageName + "BobCheckBoxMenuItemUI",
      "RadioButtonMenuItemUI", bobPackageName + "BobRadioButtonMenuItemUI",
              "RadioButtonUI", bobPackageName + "BobRadioButtonUI",
             "ToggleButtonUI", bobPackageName + "BobToggleButtonUI",
                "PopupMenuUI", bobPackageName + "BobPopupMenuUI",
              "ProgressBarUI", bobPackageName + "BobProgressBarUI",
                "ScrollBarUI", bobPackageName + "BobScrollBarUI",
               "ScrollPaneUI", bobPackageName + "BobScrollPaneUI",
                   "SliderUI", bobPackageName + "BobSliderUI",
                "SplitPaneUI", bobPackageName + "BobSplitPaneUI",
               "TabbedPaneUI", bobPackageName + "BobTabbedPaneUI",
                 "TextAreaUI", bobPackageName + "BobTextAreaUI",
                "TextFieldUI", bobPackageName + "BobTextFieldUI",
            "PasswordFieldUI", bobPackageName + "BobPasswordFieldUI",
                 "TextPaneUI", bobPackageName + "BobTextPaneUI",
               "EditorPaneUI", bobPackageName + "BobEditorPaneUI",
                     "TreeUI", bobPackageName + "BobTreeUI",
            "InternalFrameUI", bobPackageName + "BobInternalFrameUI",
              "DesktopPaneUI", bobPackageName + "BobDesktopPaneUI",
                "SeparatorUI", bobPackageName + "BobSeparatorUI",
       "PopupMenuSeparatorUI", bobPackageName + "BobPopupMenuSeparatorUI",
               "OptionPaneUI", bobPackageName + "BobOptionPaneUI",
                 "ComboBoxUI", bobPackageName + "BobComboBoxUI",
              "DesktopIconUI", bobPackageName + "BobDesktopIconUI"
        };
    ...
    protected void initComponentDefaults(UIDefaults table) 
    {
        ...
        Border loweredBevelBorder = new BobBorders.BevelBorder(false, 
                                           table.getColor("controlShadow"),
                                           table.getColor("controlLtHighlight"));

        Border raisedBevelBorder = new BobBorders.BevelBorder(true,                                                                  table.getColor("controlShadow"),
                                           table.getColor("controlLtHighlight"));

        Border marginBorder = new BasicBorders.MarginBorder();

        Border focusBorder = new BobBorders.FocusBorder(
        ...
        Border toggleButtonBorder = new BorderUIResource.CompoundBorderUIResource(
                                      new BobBorders.ToggleButtonBorder(
	...
	Border popupMenuBorder = new BorderUIResource.CompoundBorderUIResource(
				      raisedBevelBorder,
				      new BobBorders.BobPopupMenuBorder(
        ...
        Object menuItemCheckIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return BobIconFactory.getMenuItemCheckIcon();
            }
        };

        Object menuItemArrowIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return BobIconFactory.getMenuItemArrowIcon();
            }
        };

        Object menuArrowIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return BobIconFactory.getMenuArrowIcon();
            }
        };

        Object checkBoxIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return BobIconFactory.getCheckBoxIcon();
            }
        };

        Object radioButtonIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return BobIconFactory.getRadioButtonIcon();
            }
        };
	...
	Object multilineInputMap = new UIDefaults.LazyInputMap(new Object[] {
        ...
        Object treeOpenIcon = new ImageIcon(this.getClass().getResource("/org/gcreator/bob/boblook/resources/TreeOpen.png"));

        Object treeClosedIcon = new ImageIcon(this.getClass().getResource("/org/gcreator/bob/boblook/resources/TreeClosed.png"));

        Object treeLeafIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return BobTreeCellRenderer.loadLeafIcon();
            }
        };

        Object treeExpandedIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return BobTreeUI.BobExpandedIcon.createExpandedIcon();
            }
        };

        Object treeCollapsedIcon = new UIDefaults.LazyValue() {
            public Object createValue(UIDefaults table) {
                return BobTreeUI.BobCollapsedIcon.createCollapsedIcon();
            }
        };

        Border menuBarBorder = new BobBorders.MenuBarBorder(
       ...
       "shift ctrl alt F6", "selectPreviousFrame",
	    ...
	    "List.focusInputMap",
		  ...
		  "ctrl BACK_SLASH", "clearSelection",
            ...
            "DesktopIcon.icon", new ImageIcon(this.getClass().getResource("/org/gcreator/bob/boblook/DesktopIcon.png")),
	    "DesktopIcon.border", null,
	    // These are a little odd, BobInternalFrameUI isntalls em!
		...
		"KP_RIGHT", "selectChild",
		   ...
		   "SPACE", "return"
            ...
            "OptionPane.errorIcon", SwingUtilities2.makeIcon(getClass(),
                                                             BobLookAndFeel.class,
                                                             "icons/Error.gif"),
            "OptionPane.informationIcon", SwingUtilities2.makeIcon(getClass(),
                                                                   BobLookAndFeel.class,
                                                                   "icons/Inform.gif"),
            "OptionPane.warningIcon", SwingUtilities2.makeIcon(MotifLookAndFeel.class,
                                                                MotifLookAndFeel.class,
                                                               "icons/Warn.gif"),
            "OptionPane.questionIcon", SwingUtilities2.makeIcon( MotifLookAndFeel.class,
                                                                MotifLookAndFeel.class,
                                                                "icons/Question.gif"),
