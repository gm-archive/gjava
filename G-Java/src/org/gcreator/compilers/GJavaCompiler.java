...
public class GJavaCompiler extends JFrame implements Runnable, ActionListener {
    ...
    public void run() {
        ...
        try {
            ...
            GJava.print(html, "<object classid=\"clsid:CAFEEFAC-0016-0000-0000-ABCDEFFEDCBA\"id=\"game\" width=\"" + width + "\" height=\"" + height +
                    "\"><param name=\"code\" value=\"Game.class\" /> <param name=\"archive\" value=\"" + GJava.projectname +
                    ".jar\" /> <embed pluginspage=\"http://java.sun.com/javase/downloads\" code=\"Game.class\" width=\"" + width +
                    "\" height=\"" + height + "\" type=\"application/x-java-applet\" pluginspage=\"" + GJava.projectname + ".jar\" /></embed></object>");
...
//				int status4 = javac.compile(args);
                ...
                args = new String[]{"cfm", "Projects" + File.separator + GJava.projectname + File.separator + "Java" + File.separator + GJava.projectname + ".jar",
                    ...
                    "com", "Projects" + File.separator + GJava.projectname + File.separator + "Java" + File.separator + "org"
                };//,"-C","Projects" + File.separator + GJava.projectname + File.separator + "Java" + File.separator ,"org" };

                sun.tools.jar.Main jar = new sun.tools.jar.Main(printStream, printStream, "cfm " + GJava.projectname + ".jar manifest.txt *.class org com");
                jar.run(args);
