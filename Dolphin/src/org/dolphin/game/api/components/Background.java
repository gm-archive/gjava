...
public class Background extends Variable {
    ...
    public Background(boolean background_visible, boolean background_foreground, int background_x, int background_y, int background_width, int background_height, boolean background_htiled, boolean background_vtiled, boolean background_scale, int background_hspeed, int background_vspeed, int background_blend, int background_alpha, BufferedImage background_image) {
