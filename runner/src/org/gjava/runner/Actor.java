...
public class Actor extends tile
	{
	public String G_JAVA_Object_name,	public String G_JAVA_Object_name, G_JAVA_value;
	...
	public int G_JAVA_jii, G_JAVA_xx,
	...
	public double xstart=0, ystart=0,
	public double xstart=0, ystart=0,depth = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,

	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,
			friction = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,
			friction = 0, point_speed = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,
			friction = 0, point_speed = 0, point_x = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,
			friction = 0, point_speed = 0, point_x = 0, point_y = 0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,
			friction = 0, point_speed = 0, point_x = 0, point_y = 0,instance_id,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,
			friction = 0, point_speed = 0, point_x = 0, point_y = 0,instance_id,x=0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,
			friction = 0, point_speed = 0, point_x = 0, point_y = 0,instance_id,x=0,y=0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,
			friction = 0, point_speed = 0, point_x = 0, point_y = 0,instance_id,x=0,y=0,xprevious=0,
	public double xstart=0, ystart=0,depth = 0, direction = 0, hspeed = 0, vspeed = 0, gravity = 0, gravdir = 0, gravityh = 0, gravityv = 0,
			friction = 0, point_speed = 0, point_x = 0, point_y = 0,instance_id,x=0,y=0,xprevious=0,yprevious=0;

	public int id,
	public int id, G_JAVA_ii,
	public int id, G_JAVA_ii, action_x,
	public int id, G_JAVA_ii, action_x, action_y,
	public int id, G_JAVA_ii, action_x, action_y,  speed;

	public int solid,
	public int solid, G_JAVA_Object_visible,
	...
	public int G_JAVA_locali,
	public int G_JAVA_locali,dir = 0,
	public int G_JAVA_locali,dir = 0, subimage = 0,
	public int G_JAVA_locali,dir = 0, subimage = 0, csubimage = 0,
	public int G_JAVA_locali,dir = 0, subimage = 0, csubimage = 0, G_JAVA_i = 0,
	public int G_JAVA_locali,dir = 0, subimage = 0, csubimage = 0, G_JAVA_i = 0, bbwidth = 10,
	public int G_JAVA_locali,dir = 0, subimage = 0, csubimage = 0, G_JAVA_i = 0, bbwidth = 10, bbheight = 10,
