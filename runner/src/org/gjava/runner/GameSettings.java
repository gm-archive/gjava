 ...
 */
pacorg.kage .runnergjava.runner;
import java.awt.*;
...
public static int AllowResizeGameWindow = 0;
public static int GameWindowAlwaysonTop = 0;
Color Outsidecolor = new Color (0,0,0);
public static int SetResolutionofScreen = 0;
public static int ColorDepth = 0;
public static int Resoultion = 0;
public static int Frequency = 0;
public static int NoButtonsWindowCaption = 0;
public static int UseSynchronization = 0;
public static int LetF4SwitchBetweenGameModes = 1;
...
//public static int DisplayErrorMessages = 1;
//public static int WriteErrorMessageToLog = 0;
//public static int AbortOnallErrorMessages = 0;
//public static int TreatUnintializedValuesZero = 0;
