...
import components.impl.DocumentUndoManager;
...
public class CppTextArea extends JEditTextArea
	...
	private final CppTokenMarker cTokenMarker = new CppTokenMarker();
