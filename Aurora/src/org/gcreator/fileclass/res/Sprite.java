...
public class Sprite implements Resource {
    ...
    public void setImageIconAt(int pos, ImageIcon i) {
        getAt(pos).value = i;
    }
    ...
    public ImageIcon firstImage(Project p) {
        if (countImages() <= 0) {
            return null;
        }
        return getImageIconAt(0);
    }

    public ImageIcon lastImage(Project p) {
        if (countImages() <= 0) {
            return null;
        }
        return getImageIconAt(countImages() - 1);
    }
