 ...
 */
public class French extends Dictionary {
    public French() {
        status = "Fini";
        language = "Français";
        authors = new String[10];
        authors[0] = "Serge Humphrey";
        authors[1] = "Donald Humphrey";
        ...
        entry[26] = "Bonjour!"; //Tab name
        entry[27] = "Au secours!"; //Tab name
	...
	entry[46] = "Add Scene";
        ...
        //Find
        entry[76] = "Recherche"; //Title
        entry[77] = "Recherche"; //Label
        entry[78] = "Text to find";
        entry[79] = "Recherche"; //Button
        ...
        entry[275] = "Place at top left (don't resize image)";
        entry[276] = "Place at:";
        entry[277] = "Canvas Size";
        entry[278] = "Use maximal size";
        entry[279] = "Use original size";
        entry[280] = "Use new size";
        entry[281] = "OK";
        entry[282] = "Stretch";
