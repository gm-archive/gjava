...
public class GScriptScanner extends Scanner
{
    ...
    public GScriptScanner()
    {
        super();
        super.sharpcomment = true;
        initKind();
        initUniKind();
    }
    ...
    protected void initSymbolTable()
    {
        ...
        lookup(KEYWORD2, "score");
        lookup(KEYWORD2, "lives");
        lookup(KEYWORD2, "health");
        lookup(KEYWORD2, "self");
        lookup(KEYWORD2, "other");
    }
