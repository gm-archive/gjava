...
public class TextAreaPainter extends JComponent implements TabExpander
	...
	public void paint(Graphics gfx)
		...
		try
			...
			for (int line = firstInvalid; line <= lastInvalid; line++)
				{
				paintLine(g2,tokenMarker,line,x);
				}
	...
	protected void paintPlainLine(Graphics gfx, int line, Font defaultFont, Color defaultColor,
		...
		if (eolMarkers)
			...
			gfx.drawString(EOL_MARKER,x,y);
			}
		}

	protected void paintSyntaxLine(Graphics gfx, TokenMarker tokenMarker, int line, Font defaultFont,
