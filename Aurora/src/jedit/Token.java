...
public class Token
	...
	/**
	 * Literal 1 token id. This can be used to mark a string literal
	 * (eg, C mode uses this to mark "..." literals)
	 */
	public static final byte LITERAL1 = 3;
	/**
	 * Literal 2 token id. This can be used to mark an object literal
	 * (eg, Java mode uses this to mark true, false, etc)
	 */
	...
	/**
	 * Keyword 1 token id. This can be used to mark a keyword.
	 * This should be used for general language constructs.
	 */
	public static final byte KEYWORD1 = 6;
	/**
	 * Keyword 2 token id. This can be used to mark a keyword.
	 * This should be used for preprocessor commands, or variables.
	 */
	public static final byte KEYWORD2 = 7;
	/**
	 * Keyword 3 token id. This can be used to mark a keyword.
	 * This should be used for data types.
	 */
	public static final byte KEYWORD3 = 8;
	/**
	 * Operator token id. This can be used to mark an operator.
	 * (eg, SQL mode marks +, -, etc with this token type)
	 */
	public static final byte OPERATOR = 9;
	/**
	 * Invalid token id. This can be used to mark invalid
	 * or incomplete tokens, so the user can easily spot syntax errors.
	 */
